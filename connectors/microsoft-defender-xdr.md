...
- [Microsoft Defender XDR](#microsoft-defender-xdr)
  ...
  - [Tables and Rationale](#tables-and-rationale)
    - [Endpoint Tables (Microsoft Defender for Endpoint)](#endpoint-tables-microsoft-defender-for-endpoint)
    - [Alert Tables](#alert-tables)
    - [Email Tables (Microsoft Defender for Office 365)](#email-tables-microsoft-defender-for-office-365)
    - [Identity Tables (Microsoft Defender for Identity)](#identity-tables-microsoft-defender-for-identity)
    - [Cloud App Tables (Microsoft Defender for Cloud Apps)](#cloud-app-tables-microsoft-defender-for-cloud-apps)
    - [Incident and Alert Sync Tables](#incident-and-alert-sync-tables)
...
| **XDR Data Volume Insights** | KQL Query | Measure Defender XDR and Entra ID table sizes, daily averages, and event counts to inform Analytics vs Data Lake tier decisions | [GitHub — mathijsvermaat/DefenderIngestToSentinelKQL](https://github.com/mathijsvermaat/DefenderIngestToSentinelKQL) | [Walkthrough](../procedures/xdr-data-volume-insights.md) |
